        ...
        <div className="container px-5 py-10 mx-auto text-center lg:px-40">
          <div className="flex flex-col w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Below, you can view a sample of the work that I've done. Both personal and professional
              ...
              <a
                ...
                <div className="flex relative">
                  <img
                    ...
                    src={project.image}
                  />
                  <div className="px-8 py-10 relative z-10 w-full border-2 border-orange-700 bg-gray-900 opacity-0 hover:opacity-100">
